...
while (lenYT > 0) and count<maxcount:
   ...
   try:
      yt = YouTube(t, 'ANDROID',
                   on_progress_callback = on_progress)
      # ANDROID, ANDROID_CREATOR, WEB
      yt_title = yt.title
      print(yt_title)
      ...
      ys.download(output_path=new_path, filename=re.sub(r'[^\w]', '_', yt_title) + '_' + getVideoID(t) +'.mp4')
